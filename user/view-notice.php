...
<html lang="vi">
<head>
    <title>Hệ thống Quản lý Sinh viên || Xem Thông báo</title>
    <!-- plugins:css -->
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> Xem Thông báo </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard.php">Bảng điều khiển</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Xem Thông báo</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table border="1" class="table table-bordered mg-b-0">
                                        ...
                                        <?php $cnt=$cnt+1;}} else { ?>
                                        <tr>
                                            <th colspan="2" style="color:red;">Không tìm thấy thông báo</th>
                                        </tr>
                                        <?php } ?>
                                    </table>
                                </div>
