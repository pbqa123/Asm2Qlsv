                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> View All Notices</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                || <a href="manage-notice.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Are you sure you want to delete?');"> <i class="icon-trash"></i></a>
                                            </div>
                                        </td> 
                                    </tr>
                                <?php $cnt = $cnt + 1;
