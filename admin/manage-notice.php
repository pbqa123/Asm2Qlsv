...
<head>
    ...
    <title>Hệ thống Quản lý Sinh viên ||| Quản lý Thông báo</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Quản lý Thông báo </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Quản lý Thông báo</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Xem tất cả Thông báo</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Tiêu đề Thông báo</th>
                            <th class="font-weight-bold">Lớp</th>
                            <th class="font-weight-bold">Phần</th>
                            <th class="font-weight-bold">Ngày Thông báo</th>
                            ...
                            if($query->rowCount() > 0) {
                                foreach($results as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <a href="edit-notice-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-notice.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Bạn có thực sự muốn xóa ?');"> <i class="icon-trash"></i></a>
                                            </div>
                                        </td> 
                                    </tr>
                                <?php $cnt = $cnt + 1;
